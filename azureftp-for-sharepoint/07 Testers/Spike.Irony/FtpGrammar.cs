...
namespace Spike.Irony
{
    ...
    public class FtpGrammar : Grammar
    {
        ...
        public FtpGrammar() : base(false)
        {
            ...
            command.Rule = openCommand | cdCommand | dirCommand | closeCommand | getCommand | byeCommand;
            ...
            byeCommand.Rule = byeKeyword + NewLine;
            ...
            MarkPunctuation("open", "dir", "ls", "close", "get", "cd", "bye");
            Root = program;
